...
🧪 Software Testing & Automation (CI/CD, DevOps)
---

## 🚀 About Me

I'm a software engineer with experience in **systems programming, automated testing, robotics software, and deep learning**.  
I enjoy building **efficient, reliable, and well-structured software**, and I like combining **low-level engineering** with **data-driven and learning-based approaches**.

- 🛠 Experience with **C++, C#, Python**
- 🧠 Hands-on experience with **deep learning models and training pipelines**
- 🧪 Strong background in **automated testing** and **CI/CD**
...
- 💼 [LinkedIn](https://www.linkedin.com/in/yuhangchen1/)
- 🌱 Currently learning: **Advanced C++, engine architecture, performance optimization**
